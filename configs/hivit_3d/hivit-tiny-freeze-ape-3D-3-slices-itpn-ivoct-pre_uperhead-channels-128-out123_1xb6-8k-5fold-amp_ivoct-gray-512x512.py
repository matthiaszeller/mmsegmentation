_base_ = [
    '../_base_/models/upernet_hivit_tiny.py', '../_base_/datasets/ivoct_gray_3D.py',
...
checkpoint = 'checkpoints/itpn-pixel_3D-3-slices_hivit-tiny-p16-ape-alpha_4xb30-amp-coslr-400e_ivoct-gray_epoch-320.pth'
model = dict(
...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        ...
        custom_keys={
            ...
            'pos_embed': dict(decay_mult=0., lr_mult=0.0),
...
train_cfg = dict(max_iters=8000, val_interval=200)
